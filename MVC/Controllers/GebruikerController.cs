...
namespace Models
{
    public class GebruikerController : Controller
    {
        ...
        public GebruikerController(FutureDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,EMail,Geboortedatum,Voornaam,Achternaam,Straat,Huisnummer,Postcode,Stad,Telefoonnummer")] Gebruiker gebruiker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,EMail,Geboortedatum,Voornaam,Achternaam,Straat,Huisnummer,Postcode,Stad,Telefoonnummer")] Gebruiker gebruiker)
        {
            if (id != gebruiker.Id)
            {
                return NotFound();
